...
%% Scenario II, use SVM classifier
...
for b=b1(1:end)
    ...
    c1(c1==b)=[];
    c=c1(1); d=c1(2);
    Class=cat(1,Class,[a,b,c,d]);
    Class=cat(1,Class,[c,d,a,b]);
end
...
parfor ds=1:nDatasets
    ds
    a=Class(ds,1); b=Class(ds,2); c=Class(ds,3); d=Class(ds,4);
    Label1=[a,b]; Label2=[c,d];
...
save('main2_TL.mat','Accs','Class','yidx')